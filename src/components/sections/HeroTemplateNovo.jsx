...
function HeroTemplateNovo({
  ...
  return (
    ...
    >
      <section className="relative min-h-[90vh] w-full pt-[60px] phone2:pt-[90px] pb-[30px] phone3:pt-[20px] tablet1:pt-[170px] desktop1:pt-[180px] flex items-center justify-center overflow-hidden font-mainFont">
        ...
        <SectionWrapper>
          <div className="container relative z-10 grid lg:grid-cols-2 gap-4 phone2:gap-6 lg:gap-20 items-center">
            ...
            >
              ...
              <h1
                className={` desktop1:text-start text-[21px] phone2:text-[28px] phone3:text-4xl md:text-5xl lg:text-7xl font-medium leading-[1.1] ${text} `}
              >
                {content.texts.hero.title}
              </h1>

              <p
                className={`text-start desktop1:text-start text-[12px] phone2:text-[12px] phone3:text-[14px] md:text-xl leading-relaxed max-w-lg font-secondFont font-extralight ${textOpacity}`}
              >
